...
function getAxiosParams(productParams: ProductParams) {
    ...
    if (productParams.brands) params.append("searchTerm", productParams.brands.toString());
    if (productParams.types) params.append("searchTerm", productParams.types.toString());
    return params;
}
